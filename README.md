...
Deploy to GitHub pages. This will result in a URL that looks like https://<your-github-username>.github.io/Web-Design-Challenge.


The URL above will point to the index.html file in your repository. You will need to add additional html files to the repo that will be linked to from your index.html.
